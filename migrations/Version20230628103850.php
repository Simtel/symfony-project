 ...
 */
final class Version20230628103850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8F3F68C5DE12AB56 ON log');
        $this->addSql('ALTER TABLE
          log
        ADD
          CONSTRAINT FK_8F3F68C5DE12AB56 FOREIGN KEY (created_by) REFERENCES user (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8F3F68C5DE12AB56 ON log (created_by)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX UNIQ_8F3F68C5DE12AB56 ON log (created_by)');
        $this->addSql('ALTER TABLE contact DROP FOREIGN KEY FK_4C62E638A76ED395');
        $this->addSql('ALTER TABLE
          contact
        ADD
